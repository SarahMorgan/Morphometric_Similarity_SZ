...
```
If you are using these data for your own analyses, please note that there is one outlier subject in the Cobre MD and FA values (as discussed in the SI of the paper). The outlier is at row 62.
